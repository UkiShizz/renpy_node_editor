...
BLOCK_DESCRIPTIONS = {
    ...
    BlockType.START: "Стартовый блок. Точка входа в сцену. Может содержать jump/call для перехода на другую метку. Подключайте к нему все блоки, которые должны выполняться первыми.",
